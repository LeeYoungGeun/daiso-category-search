...
def get_adapter(provider: str = "", **kwargs) -> BaseAdapter:
    ...
    Provider resolution order:
        ...
        3. Default: ``"whisper"`` (local, no external API calls)

    Args:
        provider: "whisper" or "google". Empty string → use env/default.
    ...
    Environment:
        STT_PROVIDER  — "whisper" (default, local) | "google" (external API)
    """
    import os
